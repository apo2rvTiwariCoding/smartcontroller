/**************************************************************************************************
  ...
  Revised:        $Date: 2014-01-16 15:09:01 -0800 (Thu, 16 Jan 2014) $
  Revision:       $Revision: 36869 $
...
// ASE CHANGE: Added new cluster commands
/*******************************/
/*** ASE CUSTOM Cluster Commands ***/
/*******************************/
#define COMMAND_ASE_CUSTOM_REQ                            0x11
#define COMMAND_ASE_CUSTOM_RESP				  0x12
/*******************************/
...
#define COMMAND_ALARMS_CLEAR                              0x02
...
typedef struct
{
  ...
  uint8			   dataLen;	 // Data lenght
  uint8 		   cmdId;	 // Command identifier
  afAddrType_t             srcAddr;     // Requestor's address
} zclASECustomPkt_t;
...
// ASE Change: New function pointer added for ASE custom
typedef ZStatus_t (*zclASE_CustomPkt_t)( zclASECustomPkt_t *pkt );
...
/*
 * Send out an Alarm Clear Command
 */
extern ZStatus_t zclGeneral_SendAlarmClear( uint8 srcEP, afAddrType_t *dstAddr,
                                            uint8 alarmCode, uint16 clusterID,
                                            uint8 disableDefaultRsp, uint8 seqNum );
/*
