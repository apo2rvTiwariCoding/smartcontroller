/**************************************************************************************************
  ...
  Revised:        $Date: 2014-02-05 10:01:44 -0800 (Wed, 05 Feb 2014) $
  Revision:       $Revision: 37129 $
...
/*********************************************************************
 * @fn      zclGeneral_SendAlarmClear
 *
 * @brief   Call to send out an Alarm Clear Command
 *
 * @param   srcEP - Sending application's endpoint
 * @param   dstAddr - where you want the message to go
 * @param   alarmCode - code for the cause of the alarm
 ...
 * @return  ZStatus_t
 */
ZStatus_t zclGeneral_SendAlarmClear( uint8 srcEP, afAddrType_t *dstAddr,
                                     uint8 alarmCode, uint16 clusterID,
                                     uint8 disableDefaultRsp, uint8 seqNum )
{
  uint8 buf[3];
  ...
  return zcl_SendCommand( srcEP, dstAddr, ZCL_CLUSTER_ID_GEN_ALARMS,
                          COMMAND_ALARMS_CLEAR, TRUE, ZCL_FRAME_SERVER_CLIENT_DIR,
                          disableDefaultRsp, 0, seqNum, 3, buf );
}
