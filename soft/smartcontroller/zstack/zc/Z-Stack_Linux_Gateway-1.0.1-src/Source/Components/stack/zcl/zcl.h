...
// ASE CHANGE: Adding new cluster
#define ZCL_CLUSTER_ID_HA_ASE_CUSTOM			     0xFC01
...
// ASE CHANGE: Adding new cluster
#define ASE_MANUFACTURER_CODE				0xFEED
...
// ASE CHANGE: Added macro to verify the cluster id.
#define ZCL_CLUSTER_ID_HA_ASE( id )   ( (id) == ZCL_CLUSTER_ID_HA_ASE_CUSTOM )
...
/*
 *  Get the option record that matchs the cluster id
 */
