...
CREATE TABLE `alarms_zigbee` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=latin1 PACK_KEYS=0;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `smartplugsdyn` VALUES (25,1,127);
...
-- Dump completed on 2014-06-19 16:21:59
